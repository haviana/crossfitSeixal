...
class __TwigTemplate_3570d21115ae0e201dadf6a35d2287809763b09294b6e2719d5edb4fe3afa93a extends Twig_Template
{
  ...
  <video id=\"video";
            ...
            echo $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "media", array()), $this->getAttribute($context["video"], "poster", array()), array(), "array"), "url", array());
            echo "\" data-setup='{}'>
    ";
            // line 5
            $context['_parent'] = $context;
    ...
    function htmlVideo() {
      videojs(\"video";
        ...
        var myPlayer = this;
        var aspectRatio = 8 / 12; // aspect ratio 12:5 (video frame 960x400)
  ...
  {% endfor %}
", "modular/video.html.twig", "/Volumes/Dados/workspace/crossfitSeixal/user/themes/landio/templates/modular/video.html.twig");
    }
}
